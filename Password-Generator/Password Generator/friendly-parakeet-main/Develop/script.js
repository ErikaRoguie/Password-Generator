...
function passworGeneration() {
  ...
  var locationType = [Public passworGeneration * 3; break; home = passworGeneration * 2; break; home office = passworGeneration; break; work = no.generatePassword];
  console.log("What is your location?");
  console.log("What is your internet security?");
};
...
function writePassword() {
  var openPassword = selfGeneratedPassword;
